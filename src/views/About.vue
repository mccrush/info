  ...
  <div class="row">
    <div class="col-12 pt-3">
      ...
      <p class="lh-sm mt-3">
        У проекта есть
        <a
          href="https://discord.gg/eYD3fGckcF"
          target="_blank"
          title="Перейти в Discord"
          >Discord канал</a
        >, в котором мы обсуждаем решения задач и разбираем задания из ОГЭ
      </p>
      <p class="lh-sm mt-3">
        Info 🎓 Math —
        ...
        <a
          ...
          >Github</a
        >. Идеи и предложения по развитию проекта, присылайте на адрес
        <a
          href="mail:mccrush2027@gmail.com"
          target="_blank"
          title="Отправить сообщение"
          >mccrush2027@gmail.com</a
        >
      </p>
      <div class="row mt-3">
